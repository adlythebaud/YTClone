...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // A react application is made up of many different components.
	...
	*/
	...
	// get react from installed modules with this code.
	// "/." means current directory. Specify the complete path when we import files we create.


	// import VideoListItem from './components/video_list_item';
	console.log("Test"); // this works!

	// got this from console.developers.google.com
	var API_KEY = 'AIzaSyBLq_ew8B9RtSyQyOIeCL-Inyxg_Zd8104'; // only the most parent component should do fetching from an API.

	// let's update the search input..


	// this is a class. Not an instance. So, is this also a component?

	var App = function (_Component) {
		_inherits(App, _Component);

		// "const" is ES6 syntax. I forgot a closing tag 😂😂😂
		...
		function App(props) {
			...
			// override the parent class's prop.


			_this.state = {
				videos: [],
				selectedVideo: null
			}; // Set the state to an empty array for our videos
			// Our YTSearch... function? What is this again?
			_this.videoSearch('skateboards');
			return _this;
		}
		...
		_createClass(App, [{
			...
			value: function videoSearch(term) {
				...
				// another callback to search new videos.
				(0, _youtubeApiSearch2.default)({ key: API_KEY, term: term }, function (videos) {
					// => is synonymous with making a function.
					_this2.setState({ // setting the state causes the component to re-render.
						videos: videos,
	...
	// onVideoSelect={selectedVideo => this.setState({selectedVideo})} -> we're passing a function into another component that updates that component's properties.

	// <VideoList videos={this.state.videos} /> -> this is referred to as passing a prop. We're passing a prop from App to VideoList.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /*
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               	When user types something in, we need to make an API request.
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */


	// import ReactDOM from 'react-dom';

	// functional component. One function comes in, one JSX component goes out.
	// const SearchBar = () => {
	// 	return <input />;
	// };

	/*
		State is a plain JS objec that is used to record and react to user events.
		Each class based component that we define has it's own state object. Whenever we change
		a component, the render is re-ran. It's simple AJAX.... I think.
	*/

	/*
		Syntax for declaring a class-based component.
	*/
	var SearchBar = function (_Component) {
		_inherits(SearchBar, _Component);

		// create a SearchBar class. It's parent is React.Component? Yup! We changed it to "class SearchBar extends Component". Add { Component }
		// Need to define a render method. Every class based react component needs to define a render method.


		function SearchBar(props) {
			_classCallCheck(this, SearchBar);

			// component itself already has it's own constructor.

			var _this = _possibleConstructorReturn(this, (SearchBar.__proto__ || Object.getPrototypeOf(SearchBar)).call(this, props)); // this function gets called all the time when we create a new instance of SearchBar.


			_this.state = { term: "" }; // only in our constructor function will we ever change state.
		...
		_createClass(SearchBar, [{
			...
			value: function render() {
				...
				// We need dis! Make sure we return JSX. All class components need a render method.
				// return <input onChange={event => console.log(event.target.value)} />;

				// always change the state with this.setState
				// input changing tells the state what to be.
				//
				// onChange={event => this.setState({ term: event.target.value })}
				// Value of the input: {this.state.term}
				// in the input tag, when we set value={this.state.term}, we set the state to what term already is.
			...
			value: function onInputChange(term) {
				// set state with term.
				// call callback we got from index in app.
	...
	// it's ok to do this.state.term to reference the state. It is NOT OK to use this.state.term to update the state. Always use this.setState({ ... }) to change the state.

	// I could always add an event listener function inside this class as well...
	/*
		So what's happening here?:
			- We change the input in our web app, and the onChange event handler gets called.
		- When the onChange event handler is called, this.setState is called, and the term is set to event.target.value.
		- We set "this.state.term" with "this.setState()"
		- term is variable we use to change the state of our class-based component.
	*/
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// import the actual name of the component.


	/*
		Component that is the list of all the videos to the right of our video player (video_detail component)
	  We'll make this a plain functional component, but I want to make it a class-based component in the future.
	*/
	// test comment.
	// another test comment.
	// const videos = props.videos;
	/*
	  We'll map a function to every item in the array.
	...
	var VideoList = function VideoList(props) {
	  var videoItems = props.videos.map(function (video) {
	    ...
	    return _react2.default.createElement(_video_list_item2.default, {
	      ...
	      key: video.etag,
	      video: video }); // etag is a property of video that is returned from the youtube API. console log video to find out it's properties.
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// arguments inside the parentheses in following line are properties of the prop.
	/*
	  Almost as if we did:
	...
	*/
	var VideoListItem = function VideoListItem(_ref) {
	  ...
	  // synonymous with saying const video = props.video; The argument used to be props, not {video}
	  // to get access to the video, we need to access props.video.


	  // now let's add a whole bunch of markup to style.
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	   	...
	   	Each item in the list of videos (suggested videos to watch).
	   
	     I returned this inside my return method:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var VideoDetail = function VideoDetail(_ref) {
	  ...
	  if (!video) {
	    ...
	    ); // do this rarely. Do it on parent level components.
	  }

	  var videoId = video.id.videoId; // um what? From the video object obtained from Youtube API.
	  var url = "https://www.youtube.com/embed/" + videoId; // same as const url = 'https://www.youtube.com/embed/' + videoId;

	  // this return statement will not display the video while selfControl is running, because selfControl blocked youtube!! Lol.
	  return _react2.default.createElement(
	    "div",
	    ...
	    _react2.default.createElement(
	     ...
	     This is the actual video playing.
	   */
